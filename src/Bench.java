...
public class Bench {
     ...
     **/
    private static int[] SAMPLE_SIZES = new int[]{10, 30, 100, 300, 1000, 3000,
            10000, 30000, 100000};
    ...
    public static Function<int[], int[]> insertionSort = new Function<int[],
            int[]>() {
        @Override
    ...
    private static String execute(Function<int[], int[]> algorithm, int[] input) {
        ...
        if (Arrays.equals(result, reference)) {
            return String.format("%6f", (double) runtime / ((long) repetitions *
                    1000000));
        } else {
            return "INCORRECT";
        }
